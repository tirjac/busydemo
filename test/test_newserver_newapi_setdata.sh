...
## ---- main
${UNIFIED_CLIENT} localhost ${NEWSERVER_PORT} ${NEWSERVER_CACERT} ${NEWSERVER_CERT} ${NEWSERVER_KEY} ${NEWSERVER_USER} ${NEWSERVER_PASS} "/newapi/setdata" "POST" "{\"portfolio\":\"reliance,infosys\",\"flavour\":\"vanilla\"}"
