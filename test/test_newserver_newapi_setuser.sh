...
## ---- main
${UNIFIED_CLIENT} localhost ${NEWSERVER_PORT} ${NEWSERVER_CACERT} ${NEWSERVER_CERT} ${NEWSERVER_KEY} ${NEWSERVER_USER} ${NEWSERVER_PASS} "/newapi/setuser" "POST" "{\"nickname\":\"alice\",\"age\":30}"
