...
## ---- main
${UNIFIED_CLIENT} localhost ${OLDSERVER_PORT} ${OLDSERVER_CACERT} ${OLDSERVER_CERT} ${OLDSERVER_KEY} ${OLDSERVER_USER} ${OLDSERVER_PASS} "/oldapi/setdata" "POST" "{\"assets\":\"tata,wipro\",\"colour\":\"blue\"}"
